...
# ══════════════════════════════════════════════════════
#
# The ontology data is defined in ontology_data.json (50 concepts across
# 6 semantic domains).  This keeps the source clean and makes the
# vocabulary easy to extend without touching Python code.
...
def _build_domain_concepts(
    concepts: Dict[str, ConceptNode],
    domain_name: str,
    entries: list[tuple],
) -> None:
    """Populate *concepts* from declarative *entries* for *domain_name*.

    Each entry is a tuple:
        (concept_id, universal_name, description, children, parent,
         language_terms, paradigm_traits)
    """
    for (
        concept_id, universal_name, description,
        children, parent, language_terms, paradigm_traits,
    ) in entries:
        concepts[concept_id] = ConceptNode(
            ...
            paradigm_traits=paradigm_traits,
            parent=parent,
        )


_ONTOLOGY_DEFINITIONS: dict[str, list[tuple]] = {
    "execution": [
        ("agent_action", "Agent",
         "An autonomous entity that can initiate actions and make decisions",
         ["function", "application"], "",
         {"zho": ["执行者", "代理"], "deu": ["Agent", "Akteur"],
          "kor": ["실행자", "에이전트"], "san": ["kartā", "kāraka"],
          "lat": ["Actor", "Agens"], "wen": ["執行者", "使"]},
        ...
        ("function", "Function",
         "A reusable computation that maps inputs to outputs",
         ["abstraction", "conditional", "map", "filter", "reduce"], "agent_action",
         {"zho": ["函数", "功能"], "deu": ["Funktion"],
          "kor": ["함수"], "san": ["upakāra", "kārya"],
          "lat": ["Functio", "Ratio"], "wen": ["用", "功"]},
        ...
        ("application", "Application",
         "Applying a function to arguments, producing a result",
         ["pipeline", "chain"], "agent_action",
         {"zho": ["应用", "适用"], "deu": ["Anwendung", "Applikation"],
          "kor": ["적용"], "san": ["prayoga"],
          "lat": ["Applicatio"], "wen": ["行", "施"]},
        ...
        ("abstraction", "Abstraction",
         "Generalizing a computation by parameterizing over values",
         [], "function",
         {"zho": ["抽象"], "deu": ["Abstraktion"],
          "kor": ["추상화"], "san": ["apahāra", "nirvacana"],
          "lat": ["Abstractio"], "wen": ["隱", "約"]},
        ...
        ("conditional", "Conditional",
         "Branching execution based on a boolean predicate",
         [], "function",
         {"zho": ["条件"], "deu": ["Bedingung"],
          "kor": ["조건"], "san": ["paryeṣa", "vicāra"],
          "lat": ["Condicio", "Si"], "wen": ["然", "若"]},
        ...
        ("loop", "Loop",
         "Repeated execution of a computation while a condition holds",
         ["sequence", "parallel"], "",
         {"zho": ["循环"], "deu": ["Schleife"],
          "kor": ["반복", "루프"], "san": ["āvṛtti"],
          "lat": ["Circuitus", "Iteratio"], "wen": ["循"]},
        ...
        ("sequence", "Sequence",
         "Ordered execution of steps, one after another",
         ["pipeline"], "loop",
         {"zho": ["序列", "顺序"], "deu": ["Sequenz", "Reihenfolge"],
          "kor": ["순서"], "san": ["krama", "anukrama"],
          "lat": ["Series", "Ordo"], "wen": ["序"]},
         {"san": {"morphology": "verbal_noun", "root": "kram_step"},
          "wen": {"morphology": "single_char", "meaning": "order_sequence"}}),
        ("parallel", "Parallel",
         "Simultaneous execution of multiple computations",
         ["fork"], "loop",
         {"zho": ["并行", "平行"], "deu": ["Parallel"],
          "kor": ["병렬"], "san": ["sāhacarya", "samānakāla"],
          "lat": ["Parallelus", "Concurrentia"], "wen": ["並"]},
        ...
        ("fork", "Fork",
         "Splitting execution into independent branches",
         ["join"], "parallel",
         {"zho": ["分支"], "deu": ["Gabelung", "Verzweigung"],
          "kor": ["분기"], "san": ["śākhā"],
          "lat": ["Furca", "Divisio"], "wen": ["分"]},
        ...
        ("join", "Join",
         ...
         [], "fork",
         {"zho": ["合并", "汇合"], "deu": ["Vereinigung", "Zusammenführung"],
          "kor": ["합병"], "san": ["sangati", "samāpti"],
          "lat": ["Iunctio", "Coniunctio"], "wen": ["合"]},
         {"san": {"morphology": "compounding", "root": "gam_go"},
          "wen": {"morphology": "single_char", "meaning": "unite_join"}}),
        ("pipeline", "Pipeline",
         "Chained stages where output of one feeds into the next",
         [], "application",
         {"zho": ["流水线", "管道"], "deu": ["Pipeline", "Rohrleitung"],
          "kor": ["파이프라인"], "san": ["srotas", "pravāha-mārga"],
          "lat": ["Canalis"], "wen": ["流"]},
         {"zho": {"morphology": "compound", "character_count": 3},
          "san": {"morphology": "simple", "root": "sru_flow"}}),
        ("chain", "Chain",
         "Linked sequence of operations composed together",
         [], "application",
         {"zho": ["链", "链式"], "deu": ["Kette", "Verkettung"],
          "kor": ["체인", "연쇄"], "san": ["śreṇī", "samūha"],
          "lat": ["Catena", "Catena"], "wen": ["鏈"]},
         {"zho": {"morphology": "simple", "metal_literal": "true"},
          "wen": {"morphology": "single_char", "metal_literal": "true"}}),
        ("map", "Map",
         "Transform each element of a collection by a function",
         [], "function",
         {"zho": ["映射", "变换"], "deu": ["Abbildung", "Map"],
          "kor": ["맵"], "san": ["citrāṅkura"],
          "lat": ["Mappa", "Imago"], "wen": ["映"]},
         {"zho": {"morphology": "compound", "math_context": "true"},
          "deu": {"morphology": "compound", "math_context": "true"}}),
        ("filter", "Filter",
         "Select elements from a collection matching a predicate",
         [], "function",
         {"zho": ["过滤", "筛选"], "deu": ["Filter"],
          "kor": ["필터"], "san": ["chalanam", "parikṣa"],
          "lat": ["Filtrum", "Cribro"], "wen": ["濾"]},
        ...
        ("reduce", "Reduce",
         ...
         [], "function",
         {"zho": ["归约", "聚合"], "deu": ["Reduktion", "Faltung"],
          "kor": ["리덕션"], "san": ["saṅkṣepa", "samācaraṇa"],
          "lat": ["Reductio"], "wen": ["約"]},
         {"zho": {"morphology": "compound", "math_context": "true"},
    ...
    "data": [
        ("value", "Value",
         "An immutable datum; the most fundamental unit of data",
         ["reference", "option"], "",
         {"zho": ["值"], "deu": ["Wert"],
          "kor": ["값"], "san": ["artha"],
          "lat": ["Valor"], "wen": ["值"]},
        ...
        ("reference", "Reference",
         "An indirect pointer to a value or location in memory",
         [], "value",
         {"zho": ["引用"], "deu": ["Referenz", "Bezug"],
          "kor": ["참조"], "san": ["sambandha", "nidarśana"],
          "lat": ["Referentia", "Nomen"], "wen": ["指"]},
        ...
        ("container", "Container",
         "A data structure that holds other values",
         ["collection", "pair", "stream", "buffer", "channel"], "",
         {"zho": ["容器"], "deu": ["Container", "Gefäß"],
          "kor": ["컨테이너"], "san": ["pātra", "bhājana"],
          "lat": ["Vascus", "Receptaculum"], "wen": ["器"]},
        ...
        ("pair", "Pair",
         "An ordered tuple of exactly two elements",
         [], "container",
         {"zho": ["对", "对组"], "deu": ["Paar"],
          "kor": ["쌍"], "san": ["yugala", "dvandva"],
          "lat": ["Par", "Bini"], "wen": ["對"]},
        ...
        ("option", "Option",
         "A value that may or may not be present (nullable)",
         [], "value",
         {"zho": ["选项", "可选"], "deu": ["Option", "Vielleicht"],
          "kor": ["옵션"], "san": ["vikalpa"],
          "lat": ["Optio", "Forsitan"], "wen": ["擇"]},
         {"zho": {"morphology": "compound"},
          "san": {"morphology": "simple", "meaning": "alternative"},
          "deu": {"morphology": "loanword", "gender": "femininum"}}),
        ("result", "Result",
         "A computation outcome that is either a success value or an error",
         [], "value",
         {"zho": ["结果", "成效"], "deu": ["Ergebnis", "Resultat"],
          "kor": ["결과"], "san": ["phala"],
          "lat": ["Eventus", "Exitus"], "wen": ["果"]},
         {"san": {"morphology": "simple", "root": "phal_bear_fruit"},
          "wen": {"morphology": "single_char", "meaning": "fruit_result"}}),
        ("stream", "Stream",
         "A potentially infinite sequence of values evaluated lazily",
         [], "container",
         {"zho": ["流", "数据流"], "deu": ["Strom", "Datenstrom"],
          "kor": ["스트림"], "san": ["pravāha"],
          "lat": ["Flumen", "Fluxus"], "wen": ["川"]},
        ...
        ("buffer", "Buffer",
         "A temporary holding area for data between producer and consumer",
         [], "container",
         {"zho": ["缓冲", "缓冲区"], "deu": ["Puffer"],
          "kor": ["버퍼"], "san": ["parivāra", "avakāśa"],
          "lat": ["Buffer", "Intermedium"], "wen": ["蓄"]},
         {"zho": {"morphology": "compound", "character_count": 2},
          "deu": {"morphology": "loanword", "gender": "maskulinum"},
          "wen": {"morphology": "single_char", "meaning": "store_accumulate"}}),
        ("channel", "Channel",
         "A typed conduit for sending values between concurrent agents",
         [], "container",
         {"zho": ["通道"], "deu": ["Kanal"],
          "kor": ["채널"], "san": ["patha", "mārga"],
          "lat": ["Fossa", "Via"], "wen": ["道"]},
         {"deu": {"morphology": "simple", "gender": "maskulinum"},
    ...
    "scope": [
        ("global", "Global",
         "Accessible from anywhere in the program; top-level visibility",
         ["local", "namespace"], "",
         {"zho": ["全局"], "deu": ["Global"],
          "kor": ["전역"], "san": ["sārvabhauma"],
          "lat": ["Globalis", "Universalis"], "wen": ["天"]},
         {"san": {"morphology": "compounding", "meaning": "all+pervading"},
          "wen": {"morphology": "single_char", "meaning": "heaven_all_encompassing"}}),
        ("local", "Local",
         "Accessible only within a specific lexical block or function",
         [], "global",
         {"zho": ["局部"], "deu": ["Lokal"],
          "kor": ["지역"], "san": ["sāmīpya", "sthānīya"],
          "lat": ["Localis", "Proprius"], "wen": ["地"]},
        ...
        ("closure", "Closure",
         ...
         ["environment"], "",
         {"zho": ["闭包"], "deu": ["Abschluss"],
          "kor": ["클로저"], "san": ["pāriṣadya", "bādha"],
          "lat": ["Clausura"], "wen": ["閉"]},
         {"zho": {"morphology": "compound", "translation_origin": "english"},
          "deu": {"morphology": "simple", "gender": "maskulinum"},
          "san": {"morphology": "compounding", "meaning": "surrounding_enclosure"}}),
        ("environment", "Environment",
         "The mapping of names to values in a given scope",
         [], "closure",
         {"zho": ["环境", "上下文"], "deu": ["Umgebung", "Kontext"],
          "kor": ["환경"], "san": ["pariṇāma"],
          "lat": ["Ambiens", "Contextus"], "wen": ["境"]},
         {"zho": {"morphology": "compound"},
          "wen": {"morphology": "single_char", "meaning": "boundary_realm"}}),
        ("stack", "Stack",
         "A last-in-first-out data structure for managing call frames",
         ["namespace"], "",
         {"zho": ["栈", "栈帧"], "deu": ["Stapel"],
          "kor": ["스택"], "san": ["rāśi", "ucchrita"],
          "lat": ["Acervus", "Strues"], "wen": ["積"]},
         {"deu": {"morphology": "simple", "gender": "maskulinum"},
          "san": {"morphology": "simple", "meaning": "heap_pile"},
          "wen": {"morphology": "single_char", "meaning": "accumulate_stack"}}),
        ("heap", "Heap",
         "A region of memory for dynamically allocated, long-lived data",
         [], "",
         {"zho": ["堆", "堆内存"], "deu": ["Halde"],
          "kor": ["힙"], "san": ["kūṭa", "upari-bhāga"],
          "lat": ["Cumulus", "Acervus"], "wen": ["堆"]},
         {"deu": {"morphology": "simple", "gender": "femininum"},
          "wen": {"morphology": "single_char", "meaning": "heap_pile"}}),
        ("namespace", "Namespace",
         "A named scope that prevents identifier collisions",
         ["module"], "",
         {"zho": ["命名空间"], "deu": ["Namensraum"],
          "kor": ["네임스페이스"], "san": ["sthāna", "saṃjñā-kṣetra"],
          "lat": ["Nomen", "Spatium"], "wen": ["名"]},
        ...
        ("module", "Module",
         "A self-contained unit of code with its own namespace",
         [], "namespace",
         {"zho": ["模块"], "deu": ["Modul"],
          "kor": ["모듈"], "san": ["khaṇḍa", "pustaka"],
          "lat": ["Modulus", "Liber"], "wen": ["體"]},
         {"deu": {"morphology": "loanword", "gender": "neutrum"},
          "wen": {"morphology": "single_char", "meaning": "body_entity"}}),
    ],
    "communication": [
        ("message", "Message",
         "A discrete unit of data sent between agents",
         ["request", "response", "event"], "",
         {"zho": ["消息"], "deu": ["Nachricht"],
          "kor": ["메시지"], "san": ["sandeśa"],
          "lat": ["Nuntius"], "wen": ["訊"]},
        ...
        ("request", "Request",
         "A message asking an agent to perform an action or return data",
         [], "message",
         {"zho": ["请求"], "deu": ["Anfrage", "Bitte"],
          "kor": ["요청"], "san": ["yācanā", "prārthanā"],
          "lat": ["Petitio"], "wen": ["求"]},
        ...
        ("response", "Response",
         "A message returned as a reply to a request",
         [], "message",
         {"zho": ["响应", "回应"], "deu": ["Antwort"],
          "kor": ["응답"], "san": ["pratikriyā"],
          "lat": ["Responsio"], "wen": ["應"]},
         {"deu": {"morphology": "simple", "gender": "femininum"},
          "san": {"morphology": "compounding", "meaning": "against+action"},
          "wen": {"morphology": "single_char", "meaning": "reply_respond"}}),
        ("event", "Event",
         "A notable occurrence that agents can observe and react to",
         [], "message",
         {"zho": ["事件"], "deu": ["Ereignis"],
          "kor": ["이벤트", "사건"], "san": ["ghaṭanā"],
          "lat": ["Eventus", "Res"], "wen": ["事"]},
        ...
        ("signal", "Signal",
         "An asynchronous notification or interruption",
         ["broadcast"], "",
         {"zho": ["信号"], "deu": ["Signal"],
          "kor": ["신호"], "san": ["lakṣaṇa", "sūcana"],
          "lat": ["Signum"], "wen": ["號"]},
         {"deu": {"morphology": "loanword", "gender": "neutrum"},
          "san": {"morphology": "simple", "meaning": "mark_indicator"},
          "wen": {"morphology": "single_char", "meaning": "call_signal"}}),
        ("broadcast", "Broadcast",
         "Sending a message to all interested agents simultaneously",
         ["publish"], "signal",
         {"zho": ["广播"], "deu": ["Rundruf"],
          "kor": ["방송"], "san": ["saṃpradāya"],
          "lat": ["Divulgatio", "Praedicatio"], "wen": ["播"]},
        ...
        ("subscribe", "Subscribe",
         "Registering to receive messages on a topic or channel",
         [], "",
         {"zho": ["订阅"], "deu": ["Abonnement"],
          "kor": ["구독"], "san": ["upalakṣaṇa"],
          "lat": ["Subscriptio"], "wen": ["聽"]},
         {"deu": {"morphology": "loanword", "gender": "neutrum"},
          "san": {"morphology": "compounding", "meaning": "toward+observing"},
          "wen": {"morphology": "single_char", "meaning": "listen_hear"}}),
        ("publish", "Publish",
         "Emitting a message to all subscribers of a topic",
         [], "broadcast",
         {"zho": ["发布"], "deu": ["Veröffentlichung"],
          "kor": ["발행"], "san": ["prakāśana"],
          "lat": ["Publicatio"], "wen": ["布"]},
         {"zho": {"morphology": "compound"},
    ...
    "temporal": [
        ("instant", "Instant",
         "A specific, indivisible point in time",
         ["duration"], "",
         {"zho": ["瞬时", "时刻"], "deu": ["Augenblick", "Moment"],
          "kor": ["순간"], "san": ["kṣaṇa"],
          "lat": ["Momentum"], "wen": ["時"]},
         {"san": {"morphology": "simple", "philosophy": "buddhist_instant"},
          "wen": {"morphology": "single_char", "meaning": "time_instant"}}),
        ("duration", "Duration",
         "The length of a time interval between two instants",
         ["interval"], "instant",
         {"zho": ["持续", "持续时间"], "deu": ["Dauer"],
          "kor": ["지속"], "san": ["kāla", "sthiti"],
          "lat": ["Duratio"], "wen": ["久"]},
         {"san": {"morphology": "simple", "root": "kal_time"},
          "wen": {"morphology": "single_char", "meaning": "long_enduring"}}),
        ("interval", "Interval",
         "A continuous range of time between two endpoints",
         [], "duration",
         {"zho": ["区间", "间隔"], "deu": ["Intervall"],
          "kor": ["구간"], "san": ["antarāla"],
          "lat": ["Intervallum"], "wen": ["間"]},
         {"san": {"morphology": "compounding", "meaning": "between_space"},
          "wen": {"morphology": "single_char", "meaning": "between_space"}}),
        ("schedule", "Schedule",
         "A plan for execution at a specific future time",
         ["deadline"], "",
         {"zho": ["调度", "时间表"], "deu": ["Zeitplan"],
          "kor": ["스케줄"], "san": ["nirṇaya", "krama-kāla"],
          "lat": ["Tempus", "Ordo"], "wen": ["期"]},
         {"zho": {"morphology": "compound", "character_count": 2},
          "wen": {"morphology": "single_char", "meaning": "appointed_time"}}),
        ("deadline", "Deadline",
         "A point in time by which a computation must complete",
         [], "schedule",
         {"zho": ["截止", "截止时间"], "deu": ["Frist", "Termin"],
          "kor": ["마감"], "san": ["sīmā", "anta-kāla"],
          "lat": ["Terminus", "Finis"], "wen": ["限"]},
         {"deu": {"morphology": "simple", "gender": "femininum"},
    ...
    "meta": [
        ("type", "Type",
         "A classification of values by their structure and behavior",
         ["kind"], "",
         {"zho": ["类型"], "deu": ["Typ"],
          "kor": ["타입", "형"], "san": ["jāti"],
          "lat": ["Genus"], "wen": ["類"]},
        ...
        ("kind", "Kind",
         "A classification of types themselves (type of types)",
         [], "type",
         {"zho": ["种"], "deu": ["Art", "Gattung"],
          "kor": ["종"], "san": ["prakāra"],
          "lat": ["Species"], "wen": ["種"]},
         {"deu": {"morphology": "simple", "gender": "femininum"},
        ...
        ("trait", "Trait",
         "A named interface that types can implement",
         [], "class",
         {"zho": ["特征", "特性"], "deu": ["Eigenschaft", "Merkmal"],
          "kor": ["트레이트", "특성"], "san": ["guṇa", "lakṣaṇa"],
          "lat": ["Proprietas", "Indoles"], "wen": ["德"]},
         {"deu": {"morphology": "compound", "gender": "femininum"},
...
def _build_ontology() -> Dict[str, ConceptNode]:
    ...
    """
    concepts: Dict[str, ConceptNode] = {}
    for domain_name, entries in _ONTOLOGY_DEFINITIONS.items():
        _build_domain_concepts(concepts, domain_name, entries)
    return concepts
    ...
    def vocabulary_aware_translate(
        ...
        if not nodes:
            return TranslationResult(
                source_term=term, source_lang=source_lang,
                target_lang=target_lang, notes=["No matching concept found"],
            )

        ambiguity = len(nodes)
        sorted_terms = self._deduplicate_and_rank_terms(
            self._collect_translated_terms(nodes, source_lang, target_lang),
        )
        notes = (
            [f"Multiple concepts matched ({ambiguity})"] if ambiguity > 1 else []
        )
        ...
        return TranslationResult(
            ...
            confidence=round(sorted_terms[0][1], 4) if sorted_terms else 0.0,
