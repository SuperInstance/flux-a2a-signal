...
def _build_ontology() -> Dict[str, ConceptNode]:
    ...
    Each semantic domain is defined in its own helper function for
    ...
    concepts.update(_build_execution_domain())
    concepts.update(_build_data_domain())
    concepts.update(_build_scope_domain())
    concepts.update(_build_communication_domain())
    concepts.update(_build_temporal_domain())
    concepts.update(_build_meta_domain())
    return concepts


def _build_execution_domain() -> Dict[str, ConceptNode]:
    """Build 15 execution-domain concepts (Agents, functions, control flow)."""
    c: Dict[str, ConceptNode] = {}
    c["agent_action"] = ConceptNode(
...
def _build_data_domain() -> Dict[str, ConceptNode]:
    """Build 10 data-domain concepts (Values, references, containers)."""
    c: Dict[str, ConceptNode] = {}
    c["value"] = ConceptNode(
        concept_id="value",
...
def _build_scope_domain() -> Dict[str, ConceptNode]:
    """Build 8 scope-domain concepts (Accessibility, visibility, environments)."""
    c: Dict[str, ConceptNode] = {}
    c["global"] = ConceptNode(
        concept_id="global",
...
def _build_communication_domain() -> Dict[str, ConceptNode]:
    """Build 8 communication-domain concepts (Messages, events, signals)."""
    c: Dict[str, ConceptNode] = {}
    c["message"] = ConceptNode(
        concept_id="message",
...
def _build_temporal_domain() -> Dict[str, ConceptNode]:
    """Build 5 temporal-domain concepts (Time, duration, scheduling)."""
    c: Dict[str, ConceptNode] = {}
    c["instant"] = ConceptNode(
        concept_id="instant",
...
def _build_meta_domain() -> Dict[str, ConceptNode]:
    """Build 4 meta-domain concepts (Types, kinds, classes, traits)."""
    c: Dict[str, ConceptNode] = {}
    c["type"] = ConceptNode(
        concept_id="type",
        universal_name="Type",
